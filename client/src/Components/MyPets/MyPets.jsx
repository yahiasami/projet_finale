    ...
    <section className="my-pets">
      <aside className="flex-wrap">
        <div className="flex-col--w">
          <h3 className={menuText === 'adopted' ? 'my-pets__heading' : 'hidden'}>
            You have {profile ? profile.adoptedPets.length : 'some'} pet(s) adopted
          </h3>
          <h3 className={menuText === 'saved' ? 'my-pets__heading' : 'hidden'}>
            You have {profile ? profile.savedPets.length : 'some'} pet(s) saved
          </h3>
          <a href="/add-pet">Ajouter</a>
        ...
        <div className="flex-col-3">
          ...
          <p className="my-pets__quote">
            “Until one has loved an animal, a part of one's soul remains unawakened.” <br></br>{' '}
            –Anatole France.
          </p>
        </div>
      </aside>
